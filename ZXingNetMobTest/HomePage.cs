...
namespace ZXingNetMobTest
{
  public class HomePage : ContentPage
  {
    ...
    private readonly Button buttonScanDefaultOverlay;
    private readonly Button buttonScanCustomOverlay;
    private readonly Button buttonScanContinuously;
    private readonly Button buttonScanContinuousCustomPage;
